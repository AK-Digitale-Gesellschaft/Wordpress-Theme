...
?>
                <div class="nopassword"><?php _e('This post is password protected. Enter the password to view any comments.', 'SPD2012') ?></div>
            </div><!-- .comments -->
<?php
        return;
    endif;
...
<?php print_r($comments_by_type['comments']) ?>
<?php if (  empty($comments_by_type['comments']) ) : ?>

                <div id="comments-list" class="comments">
                    <h3><?php printf($comment_count > 1 ? __('<span>%d</span> Kommentare', 'SPD2012') : __('<span>One</span> Kommentar', 'SPD2012'), $comment_count) ?></h3>
...
<?php if ( ! empty($comments_by_type['pings']) ) : ?>
                ...
                <div id="trackbacks-list" class="comments">
                    <h3><?php printf($ping_count > 1 ? __('<span>%d</span> Trackbacks', 'SPD2012') : __('<span>One</span> Trackback', 'SPD2012'), $ping_count) ?></h3>
